...
cmt_buf_t __cmt_append(cmt_buf_t l, cmt_buf_t r)
{
	cmt_buf_t ret = cmt_alloc(cmt_length(l) + cmt_length(r));

	memcpy(ret->data, l->data, cmt_length(l));
	memcpy(ret->data + cmt_length(l), r->data, r->length);
